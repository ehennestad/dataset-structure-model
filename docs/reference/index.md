...
The schema file is [`schema/DatasetStructureModel.schema.json`](https://github.com/ehennestad/dataset-structure-model/blob/main/schema/DatasetStructureModel.schema.json). Readers emit [entity records](entity-record.md) defined by [`schema/EntityRecord.schema.json`](https://github.com/ehennestad/dataset-structure-model/blob/main/schema/EntityRecord.schema.json).
